...
namespace Scrambler.MySql.SqlScripts
{
    ...
    #line 1 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
...
#line hidden
        ...
        {
            this.Write("\r\n");
            this.Write("\r\nset GLOBAL innodb_buffer_pool_size=402653184;\r\nset innodb_lock_wait_timeout=999" +
                    "99;\r\nset session transaction isolation level serializable;\r\nset sql_safe_updates" +
                    " = 0;\r\n\r\ncreate temporary table prim_keys_and_columns_scrambler\r\n(\r\n  ");
            
            #line 20 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
  for(int i=0;i<TableInfo.PrimaryKeysAndTypes.Count;i++) 
     ...
     for(int i=0;i<TableInfo.PairedColumnsInside.Count;i++) 
      {
        ...
        for(int j = 0; j<pairedColumns.Count;j++) 
        {
            ...
            #line 45 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    for(int i = 0; i < TableInfo.SoloScrambledColumnsAndTypes.Count; i++, _scrambleTableNumber++) 
    {
        var columnName = TableInfo.SoloScrambledColumnsAndTypes.Keys.ElementAt(i);
            ...
            #line 50 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 53 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 55 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 60 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    for(int i = 0; i < TableInfo.PairedColumnsInside.Count; i++, _scrambleTableNumber++) 
    {
        var pairedColumns = TableInfo.PairedColumnsInside[i];
            ...
            #line 65 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(_scrambleTableNumber));
            ...
            #line 68 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    { 
     ...
     if (j != pairedColumns.Keys.Count-1)
     {
       Write(", ");
            ...
            #line 81 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 86 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    {   
        foreach(var columnName in pairedColumns.Keys)
        {
            ...
            #line 105 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    {   
        ...
        if (i != (TableInfo.PrimaryKeysAndTypes.Count - 1))
        {
            ...
            #line 117 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 118 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
       ...
       if( !string.IsNullOrEmpty(TableInfo.WhereClause)) 
       {
          Write($" where {TableInfo.WhereClause}");
            ...
            #line 126 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    for(int i = 0; i < TableInfo.SoloScrambledColumnsAndTypes.Count; i++, _scrambleTableNumber++) 
    {
        var columnName = TableInfo.SoloScrambledColumnsAndTypes.Keys.ElementAt(i);
            ...
            #line 131 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(_scrambleTableNumber));
            ...
            #line 132 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(columnName));
            ...
            #line 133 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(columnName));
            ...
            #line 134 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 139 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    for(int i = 0; i < TableInfo.PairedColumnsInside.Count; i++, _scrambleTableNumber++) 
    {
        var pairedColumns = TableInfo.PairedColumnsInside[i];
            ...
            #line 144 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(_scrambleTableNumber));
            ...
            #line 145 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
        ...
        { 
            ...
            #line 157 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
        ...
        { 
            ...
            #line 169 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 174 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    {   
        ...
        if (i != (TableInfo.PrimaryKeysAndTypes.Count - 1))
        {
            ...
            #line 187 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    for(int i = 0; i < _scrambleTableNumber; i++)
    {
        ...
        Write(Environment.NewLine);
            ...
            #line 196 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(TableInfo.FullTableName));
            ...
            #line 198 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    for(int i=0;i<TableInfo.PairedColumnsInside.Count;i++, scrambleTableNumberIter++) 
    {
        ...
        for(int j = 0; j < pairedColumns.Count;j++) 
        {
            ...
            #line 236 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
 scrambleTableNumberIter = 0;
    ...
    for(int i=0;i<TableInfo.PairedColumnsInside.Count;i++, scrambleTableNumberIter++) 
    {
       ...
       Write(Environment.NewLine);
            ...
            #line 250 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    for(int i=0;i<TableInfo.ConstantColumnsAndTypesAndValues.Count;i++) 
    {
        ...
        Write($"`{column.Name}` = cast('{column.Value}' as NCHAR)");                      
            ...
            #line 290 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
 for(int i = 0; i < TableInfo.PrimaryKeysAndTypes.Count; i++)
    {   
        var columnName = TableInfo.PrimaryKeysAndTypes.Keys.ElementAt(i);
        Write($"dest.`{columnName}` = x.`{columnName}`");
        ...
        if (i != (TableInfo.PrimaryKeysAndTypes.Count - 1))
        {
            ...
            #line 301 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 302 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
 scrambleTableNumberIter = 0;
    for(int i = 0; i < TableInfo.SoloScrambledColumnsAndTypes.Count; i++, scrambleTableNumberIter++)
    {   
    ...
    for(int i=0;i<TableInfo.PairedColumnsInside.Count;i++, scrambleTableNumberIter++) 
    {
       ...
       Write(Environment.NewLine);
            ...
            #line 317 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
...
//if there is more than one mapped table
    ...
    { 
        ...
        var lastMappingStep = mappedTable.MappedColumnPairsOutside.Last();
            ...
            #line 324 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            ...
            #line 325 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
        ...
        {   
            ...
            #line 387 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
        ...
        for(int i = 0; i < mappedTable.SourceDestPairedColumnsOutside.Count; i++)
        {
            ...
            #line 403 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
 } 
            ...
            #line 407 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
    ...
    foreach(var mappedTable in TableInfo.MappedTablesOutside.Where(m => m.MappedColumnPairsOutside.Count == 1))
    {
        var lastMappingStep = mappedTable.MappedColumnPairsOutside.Last();
            ...
            #line 412 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(lastMappingStep.DestinationFullTableName));
            ...
            #line 413 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(TableInfo.FullTableName));
        ...
        for(int i = 0; i < lastMappingStep.MappedColumns.Count;i++)
        {
            ...
            #line 428 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
        ...
        for(int i = 0; i < mappedTable.SourceDestPairedColumnsOutside.Count; i++)
        {
            ...
            #line 444 "F:\Szakdoga\anonymizer\AnonymizerCore\Scrambler.MySql\SqlScripts\ScrambleTable.tt"
  }
