...
namespace LoggingDal.Migrations
{
    ...
    [Migration("20200426131910_AddIndexes")]
            ...
            modelBuilder.Entity("LoggingDal.Model.Logs", b =>
                {
                    ...
                    b.HasIndex("JobDescription", "Timestamp");
                    ...
                    b.HasIndex("JobDescription", "GroupKey", "Timestamp");

                    b.HasIndex("JobDescription", "Severity", "Timestamp");

                    b.HasIndex("GroupKey", "JobKey", "Severity", "Timestamp");

                    b.HasIndex("JobDescription", "GroupKey", "Severity", "Timestamp");
